...
import styles from './ChordDraw.module.css';
import { GuitarChord, ChordName, ChordSvg } from '../lib/guitarChord.js';
...
class ChordDraw extends Component {
  ...
  render() {
    return (
      <div className={styles.containerChordDraw}>
        <div className={`${styles.drawInfo} ${this.state.info ? styles.show : ""}`}>{this.state.info}</div>
